...
| T5.2c | Tidsgruppsöversikt i startnivån | guide.html | ✅ Done | [data-test=oversikt]: klickbara periodräknare (gäller redan + årtal, 5 grupper ur datat) under startkortet; följer verksamhetsvalet (verifierat: 2/5/3/7/2 → 1/1/0/5/2 med grundskolan), nollgrupper dämpas men döljs aldrig (gruppantalet stabilt ≥4), gruppklick scrollar till periodens första synliga rad. 0 konsolfel, 0 overflow, sviterna gröna, språkregel UI 0. |
